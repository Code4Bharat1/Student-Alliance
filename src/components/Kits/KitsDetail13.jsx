...
const KitsDetail13 = () => {
  ...
  const product = {
    id: 213,
    name: "4 Wheel Robotic Platform DIY with DC gear motor, Chassis With Wheels",
    price: totalPrice,
    image: "/images/k13.jpg",
    description: " The provided material can construct a basic robot capable of moving forward and reverse with effective right and left turn capabilities.",
  };
      ...
      <div className="max-w-7xl mx-auto bg-white shadow-xl rounded-xl overflow-hidden">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 p-8">
          ...
          >
            <Image
              src="/images/k13.jpg"
              alt='4 Wheel Robotic Platform DIY with DC gear motor, Chassis With Wheels'
              width={800}
              height={800}
          ...
          >
            <div>
              <h3 className="text-3xl font-bold text-gray-800 mb-2">4 Wheel Robotic Platform DIY with DC gear motor, Chassis With Wheels</h3>
         ...
         This is a 4 wheel robotic platform DIY with DC gear motor and wheels. This is a best kit for any type of robotic project. The provided material can construct a basic robot capable of moving forward and reverse with effective right and left turn capabilities. No ball castor is required in this set. This is basically used for DIY in robotic section.
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="flex items-center gap-2">
                ...
                <span className="text-gray-700">Chassis Color: Black Chassis Material: High quality metal </span>
              </div>
              <div className="flex items-center gap-2">
                <svg className="w-5 h-5 text-purple-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>
                </svg>
                <span className="text-gray-700">Wheel Color: Black & White Wheel Dimension: 7 x 2 Wheel</span>
              </div>
              <div className="flex items-center gap-2">
                <svg className="w-5 h-5 text-purple-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>
                </svg>
                <span className="text-gray-700">Material: Plastic and Rubber Motor RPM: 500 RPM Operating Voltage:1.5~9V. </span>
              </div>
              <div className="flex items-center gap-2">
                <svg className="w-5 h-5 text-purple-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>
                </svg>
                <span className="text-gray-700"> Operating Current : 0.01A~0.3A.</span>
              </div>
            </div>
