      ...
      <div className="max-w-7xl mx-auto bg-white shadow-xl rounded-xl overflow-hidden">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 p-8">
          ...
          >
            <Image
              src="/images/k10.jpg"
              alt='DIY Dinosaur STEM Kit Kids Electric Dinosaur Robot DIY Assembly Model Science Discovery STEM Education Physics Experiment Kit Gift'
              width={800}
              height={800}
          ...
          >
            <div>
              <h3 className="text-3xl font-bold text-gray-800 mb-2">DIY Dinosaur STEM Kit Kids Electric Dinosaur Robot DIY Assembly Model Science Discovery STEM Education Physics Experiment Kit Gift</h3>
