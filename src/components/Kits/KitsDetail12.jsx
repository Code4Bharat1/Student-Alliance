...
const KitsDetail12 = () => {
  ...
  const product = {
    id: 212,
    name: "2 Wheel Smart Car Chassis Kit with Battery and L298N Motor Driver Module",
    price: totalPrice,
      ...
      <div className="max-w-7xl mx-auto bg-white shadow-xl rounded-xl overflow-hidden">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 p-8">
          ...
          >
            <Image
              src="/images/k12.jpg"
              alt='2 Wheel Smart Car Chassis Kit with Battery and L298N Motor Driver Module'
              width={800}
              height={800}
          ...
          >
            <div>
              <h3 className="text-3xl font-bold text-gray-800 mb-2">2 Wheel Smart Car Chassis Kit with Battery and L298N Motor Driver Module</h3>
