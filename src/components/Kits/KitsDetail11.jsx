...
const KitsDetail11 = () => {
  ...
  const product = {
    id: 211,
    name: "Crowbits-Creator Kit Based on Arduino, 12-in-1 STEM Toy for Kids, Educational Science Experiment Set, Coding Block Sensor Module, Crowbits Creator Kit",
    price: totalPrice,
    image: "/images/k11.jpg",
    description: "It uses Arduino as the mainboard console and combines electronic modules and Lets code which is a visual graphics programming software.",
  };
