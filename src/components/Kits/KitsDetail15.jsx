...
const KitsDetail15 = () => {
  ...
  const product = {
    id: 215,
    name: "DIY Balance Scale STEM Kit DIY Balance Scale Lever Wooden Weighing Scale Science Math Teaching Scale Early Educational Balancing Toy",
    price: totalPrice,
    image: "/images/k15.jpg",
    description: "STEM Kits are geared towards learning, curiosity, and education, focusing on developing kids' skills in science, technology, engineering, and mathematics (STEM).",
  };
