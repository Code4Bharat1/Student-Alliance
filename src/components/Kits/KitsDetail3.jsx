...
const KitsDetail3 = () => {
  ...
  const product = {
    ...
    price: totalPrice,
    image: "/images/k3.jpg",
    description: " An educational Advance Smart Robot Car Kit for beginners (kids) to get hands-on experience with Arduino programming",
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 px-4 py-8">
      <div className="max-w-7xl mx-auto bg-white shadow-xl rounded-xl overflow-hidden">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 p-8">
         ...
         Smart Robot Car: An educational Advance Smart Robot Car Kit for beginners (kids) to get hands-on experience with Arduino programming, electronics assembling, and robotics knowledge. Advance Smart Robot Car Kit is an integration solution for robotics learning and is made for Arduino education.
            </p>
