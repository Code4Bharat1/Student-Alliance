...
const KitsDetail16 = () => {
  ...
  const product = {
    id: 216,
    name: "DIY Password Case STEM Kit Portable Unassembled Password Case Material DIY Wooden Puzzle for Kids",
    price: totalPrice,
      ...
      <div className="max-w-7xl mx-auto bg-white shadow-xl rounded-xl overflow-hidden">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 p-8">
          ...
          >
            <Image
              src="/images/k16.jpg"
              alt='DIY Password Case STEM Kit Portable Unassembled Password Case Material DIY Wooden Puzzle for Kids'
              width={800}
              height={800}
          ...
          >
            <div>
              <h3 className="text-3xl font-bold text-gray-800 mb-2">DIY Password Case STEM Kit Portable Unassembled Password Case Material DIY Wooden Puzzle for Kids</h3>
