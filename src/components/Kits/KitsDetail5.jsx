  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 px-4 py-8">
      <div className="max-w-7xl mx-auto bg-white shadow-xl rounded-xl overflow-hidden">
        ...
        SMART LEARNING: Store Smart Learning Robotics IOT comes with all the components required to learn at basic to advance levels. 4 ROBOT CARS can be built like Now you have peace of mind to learn basic to advance levels with just one kit. QUALITY: High-quality components and modules are supplied with the kit.
            </p>
