...
const KitsDetail4 = () => {
  ...
  const product = {
    id: 204,
    name: "Make a Line Follower Robot Car Using L293d Motor Driver IC And BO Motor Dual Shaft",
    price: totalPrice,
    image: "/images/k4.jpg",
    description: "IR Module - 2 7805 Voltage regulator IC - 1 L293D Motor Driver IC - 1 ON/OFF SPST Switch - 1 Dual Shaft BO Motor - 2 12V",
  };
      ...
      <div className="max-w-7xl mx-auto bg-white shadow-xl rounded-xl overflow-hidden">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 p-8">
          ...
          >
            <Image
              src="/images/k4.jpg"
              alt='Make a Line Follower Robot Car Using L293d Motor Driver IC And BO Motor Dual Shaft'
              width={800}
              height={800}
          ...
          >
            <div>
              <h3 className="text-3xl font-bold text-gray-800 mb-2">Make a Line Follower Robot Car Using L293d Motor Driver IC And BO Motor Dual Shaft</h3>
         ...
         HARDWARE REQUIRED IR Module - 2 7805 Voltage regulator IC - 1 L293D Motor Driver IC - 1 ON/OFF SPST Switch - 1 Dual Shaft BO Motor - 2 12V 1A LI-PO Battery - 1 Jumper wire (Male to Male)-40 PCS Jumper Wires (male to female) – 40 pieces Single stand wire 2m – 1 2 Wheel Car Chassis KIT – 1 Breadboard 400 points - 1
            </p>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="flex items-center gap-2">
                ...
                <span className="text-gray-700"> IR Module - 2 7805 Voltage regulator IC - 1</span>
              </div>
              <div className="flex items-center gap-2">
                <svg className="w-5 h-5 text-purple-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>
                </svg>
                <span className="text-gray-700">L293D Motor Driver IC - 1 ON/OFF SPST Switch - 1 Dual Shaft BO Motor - 2 12V 1A LI-PO Battery - 1 </span>
              </div>
              <div className="flex items-center gap-2">
                <svg className="w-5 h-5 text-purple-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>
                </svg>
                <span className="text-gray-700">Jumper wire (Male to Male)-40 PCS Jumper Wires (male to female) – 40 pieces Single stand wire 2m </span>
              </div>
              <div className="flex items-center gap-2">
                <svg className="w-5 h-5 text-purple-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>
                </svg>
                <span className="text-gray-700"> 1 2 Wheel Car Chassis KIT – 1 Breadboard 400 points - 1</span>
              </div>
            </div>
