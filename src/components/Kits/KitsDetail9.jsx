...
const KitsDetail9 = () => {
  ...
  const product = {
    id: 209,
    name: "4WD 4 Wheel Smart Car Chassis DIY 4WD Double-Deck Smart Robot Car Chassis Kits with Speed Encoder 4 Wheel 2 Layer Robot Smart Car Chassis Kit",
    price: totalPrice,
    image: "/images/k9.jpg",
    description: "we will make an IoT based wireless Wi-fi robot car using the NodeMCU ESP8266-12e Wi-Fi board with the L298n Motor driver module.",
  };
      ...
      <div className="max-w-7xl mx-auto bg-white shadow-xl rounded-xl overflow-hidden">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 p-8">
          ...
          >
            <Image
              src="/images/k9.jpg"
              alt='4WD 4 Wheel Smart Car Chassis DIY 4WD Double-Deck Smart Robot Car Chassis Kits with Speed Encoder 4 Wheel 2 Layer Robot Smart Car Chassis Kit'
              width={800}
              height={800}
          ...
          >
            <div>
              <h3 className="text-3xl font-bold text-gray-800 mb-2">4WD 4 Wheel Smart Car Chassis DIY 4WD Double-Deck Smart Robot Car Chassis Kits with Speed Encoder 4 Wheel 2 Layer Robot Smart Car Chassis Kit</h3>
        ...
        Introduction In this project, we will make an IoT based wireless Wi-fi robot car using the NodeMCU ESP8266-12e Wi-Fi board with the L298n Motor driver module. We will interface this Wi-fi Car with Mert Arduino application in which by entering the IP address, you can control by giving the directional command using the smartphone. 
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="flex items-center gap-2">
                ...
                <span className="text-gray-700"> Features a straightforward mechanical structure that's easy to assemble and expand for various robotics projects.</span>
              </div>
              <div className="flex items-center gap-2">
                <svg className="w-5 h-5 text-purple-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>
                </svg>
                <span className="text-gray-700"> Equipped with four deceleration DC motors and speed (tachometer) encoders for better motion control and feedback.
</span>
              </div>
              <div className="flex items-center gap-2">
                <svg className="w-5 h-5 text-purple-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <span className="text-gray-700">Offers nimble movement with good directionality and strong motor power (horsepower) for stable driving.</span>
              </div>
              <div className="flex items-center gap-2">
                <svg className="w-5 h-5 text-purple-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>
                </svg>
                <span className="text-gray-700"> Built with a large, stable platform suitable for adding sensors, controllers, and other components.</span>
              </div>
            </div>
