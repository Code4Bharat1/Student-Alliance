...
export default function Camcart9() {
  ...
  const product = {
    id: 109,
    name: "Student Alliance EPTZ 4K Webcam ",
    price: unitPrice,
    image: "/shop/cam9.png",
    description: "EPTZ 4K Webcam – Ultra HD Webcam for PC & Laptop | Auto Framing, Noise Suppression, Low-Light Correction | Best for Zoom, YouTube, Streaming & Gaming",
  };
  ...
  const images = ["/shop/cam9.png", "/shop/cam9-1.png", "/shop/cam9-2.png", "/shop/cam9-2.png"];
