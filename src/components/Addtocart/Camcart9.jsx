...
export default function Camcart9() {
  ...
  const product = {
    id: 109,
    name: "Student Alliance EPTZ 4K Webcam – Ultra HD Webcam for PC & Laptop | Auto Framing, Noise Suppression, Low-Light Correction | Best for Zoom, YouTube, Streaming & Gaming",
    price: unitPrice,
    image: "/shop/cam9.png",
