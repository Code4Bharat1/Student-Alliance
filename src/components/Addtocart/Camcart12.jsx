        ...
        <div className="flex flex-col lg:flex-row gap-12 p-8">
          ...
          <div className="flex flex-col lg:w-1/2">
            <div className="relative rounded-xl overflow-hidden mb-4 aspect-square bg-gray-50">
              <Image
                src="/shop/cam12.png"
                alt="Logitech BCC950 ConferenceCam"
                fill
          ...
          <div className="lg:w-1/2">
            ...
            <div className="mb-8 p-6 bg-gradient-to-r from-purple-50 to-blue-50 rounded-xl">
              <div className="flex items-end gap-4 mb-2">
                <span className="text-4xl font-bold text-gray-900">₹26,000</span>
                <span className="text-lg text-gray-500 line-through">₹34,000</span>
