    ...
    <tbody className="divide-y divide-gray-200 bg-white">
      ...
      <tr className="bg-gray-50">
        ...
        <td className="px-6 py-4 text-sm text-gray-500">
          Gaming Console, Webcam, Keyboard, Mouse, Printer, Card Reader, Bluetooth Adapter, USB Flash Drive, Scanner, Hard Drive
        </td>
      </tr>
      ...
      <tr className="bg-gray-50">
        ...
        <td className="px-6 py-4 text-sm text-gray-500">
          USB 3.0 Male to Female Extender Cord 10M
        </td>
      </tr>
      ...
      <tr className="bg-gray-50">
        ...
        <td className="px-6 py-4 text-sm text-gray-500">
          1 USB 3.0 Extension Cable USB 3.0 Male to Female Extender
        </td>
      </tr>
      ...
      <tr className="bg-gray-50">
        ...
        <td className="px-6 py-4 text-sm text-gray-500">
          USB 3.0 Male to Female Extender Cord
        </td>
      </tr>
