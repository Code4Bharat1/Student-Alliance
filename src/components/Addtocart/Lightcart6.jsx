...
<li className="flex items-start">
    ...
    <span className="text-black"><strong>Easy Installation:</strong>Effortless setup with simple mounting options for quick illumination.</span>
  </li>
  <li className="flex items-start">
    <span className="text-purple-500 mr-2">•</span>
...
<ul className="space-y-3 text-gray-700 text-sm">
  <li className="flex items-start">
    <span className="text-purple-500 mr-2">•</span>
    <span><strong>6 Upper LED Panels:</strong> 22 LEDs each, featuring black frames and underground cabling for a clean setup.</span>
  </li>
</ul>
