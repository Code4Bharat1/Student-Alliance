...
export default function Digital2() {
  const sizeOptions = {
    "65": { unitPrice: 89843, originalPrice: 140000, label: "65-inch", description: "Perfect for medium-sized classrooms" },
    "75": { unitPrice: 105468, originalPrice: 170000, label: "75-inch", description: "Ideal for large meeting rooms" },
    "86": { unitPrice: 175781, originalPrice: 270000, label: "86-inch", description: "Best for auditoriums and large spaces" }
  };
  ...
  const images = ["/shop/digital-d2.png", "/shop/D21.png", "/shop/D22.png", "/shop/D23.png", "/shop/D24.png"];
