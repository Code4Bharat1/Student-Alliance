...
export default function LightCart3() {
 ...
 <ul className="space-y-3 text-gray-700 text-sm">
  ...
  <li className="flex items-start">
    <span className="text-purple-500 mr-2">•</span>
    <span><strong>Professional Lighting Grid:</strong> Strategically placed panels create uniform, shadow-free illumination for studio-quality results</span>
  </li>
  <li className="flex items-start">
    <span className="text-purple-500 mr-2">•</span>
    <span><strong>Clean Aesthetic:</strong> Unified black frames and hidden wiring maintain a polished, distraction-free environment</span>
  </li>
  <li className="flex items-start">
    <span className="text-purple-500 mr-2">•</span>
    <span><strong>Modular Design:</strong> Easy-to-reposition panels adapt to any shooting scenario or space configuration</span>
  </li>
</ul>
