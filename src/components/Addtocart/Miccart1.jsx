...
export default function MicCart() {
  ...
  const images = [
    "/shop/mic1.png",
    "/shop/aboutmic1.png",
    "/shop/aboutmic1-1.png",
    "/shop/aboutmic1-2.png",
  ];
          ...
          <div className="lg:w-1/2">
            ...
            <ul className="space-y-3 text-gray-700 text-sm">
              <li className="flex items-start">
                ...
                <span>
                  Professional wireless mic for vloggers & content creators
                  (White & Black)
                </span>
              </li>
              <li className="flex items-start">
                  ...
                  <tbody className="divide-y divide-gray-200 bg-white">
                    ...
                    <tr className="bg-gray-50">
                      ...
                      <td className="px-6 py-4 text-sm text-gray-500">
                        Long range (100m), Noise Reduction, Real-time
                        monitoring, Hi-Fi audio
                      </td>
                    </tr>
                    ...
                    <tr className="bg-gray-50">
                      ...
                      <td className="px-6 py-4 text-sm text-gray-500">
                        2 Microphones, Receiver, Charging Case, Cables, Clips,
                        Manual
                      </td>
                    </tr>
