...
export default function MicCart() {
        ...
        <div className="flex flex-col lg:flex-row gap-12 p-8">
          ...
          <div className="flex flex-col lg:w-1/2">
            <div className="relative rounded-xl overflow-hidden mb-4 aspect-square bg-gray-50">
              <Image
                src="/shop/mic1.png"
                alt="AIWaft Wireless Microphone | 48kHz/24bit Audio | Noise Reduction 2.0 | 100m Range | 10H Battery | Type-C Charging | For Smartphones"
                fill
          ...
          <div className="lg:w-1/2">
            <div className="mb-6">
              <h1 className="text-3xl font-bold text-gray-900 mb-2 leading-tight">
                AIWaft Wireless Microphone | 48kHz/24bit Audio | Noise Reduction 2.0 | 100m Range | 10H Battery | Type-C Charging | For Smartphones
              </h1>
            </div>
  ...
  <h2 className="text-2xl font-bold text-gray-900 mb-6">
    AIWaft Wireless Microphone (White) – Crystal-Clear Audio for Professionals
  </h2>
  ...
  <li className="flex items-start">
    <span className="text-purple-500 mr-2">•</span>
    <span>Smart touch controls for seamless operation</span>
  </li>
</ul>
