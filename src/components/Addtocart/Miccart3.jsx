...
export default function MicCart3() {
  ...
  const product = {
    ...
    price: basePrice,
    image: "/shop/mic3.png",
    description: "Sennheiser ME 2-II Lavalier Mic with advanced noise reduction and high-fidelity audio",
  };
  ...
  const images = ["/shop/mic3.png", "/shop/aboutmic3.png", "/shop/aboutmic3-1.png", "/shop/aboutmic3-2.png"];
