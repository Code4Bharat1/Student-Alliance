...
export default function SpeakerCart4() {
  ...
  // Product details
  const product = {
    id: 4, // Different ID from previous products
    name: "Ahuja PS500TM 32 Watt Speaker",
    price: basePrice,
    image: "/shop/speaker2.png",
    description: "Ahuja PS500TM 32 Watt Speaker with high fidelity 2-Way sound and multi-purpose PA capabilities",
  };
