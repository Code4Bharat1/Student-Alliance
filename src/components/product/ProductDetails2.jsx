      ...
      <div className="max-w-7xl mx-auto bg-white shadow-lg rounded-lg p-8">
        ...
        <div className="text-sm breadcrumbs text-gray-600 mb-4">
          ...
          >
            ...
            <span className="text-purple-600">75" Inch IFPD - Interactive Flat Panel Display</span>
          </motion.h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          ...
          >
            <Image
              src="/images/75_inch.png"
              alt='75" Inch IFPD - Interactive Flat Panel Display'
              width={600}
              height={600}
          ...
          >
            <h3 className="text-2xl md:text-3xl font-semibold text-gray-800">75" Inch IFPD - Interactive Flat Panel Display</h3>
            <p className="text-gray-600 leading-relaxed">
              Our 75" Interactive Flat Panel Display is designed for powerful collaboration and immersive presentations.
              With crystal-clear 4K UHD resolution, advanced multi-touch capabilities, and dual operating system support (Android/Windows),
              it’s ideal for modern classrooms, conference rooms, and collaborative workspaces.
            </p>
            ...
            <div className="flex items-baseline gap-4 text-lg font-semibold">
              ...
              <span className="line-through text-gray-500">₹{(145000 * quantity).toLocaleString()}</span>
