...
const router = useRouter();
  ...
  const product = {
    id: 304,
    name: "3D Printer (Ender 5 Plus S 1)",
    price: totalPrice,
    image: "/images/printer4.png",
    description:
      "Bring ideas to life with the high-performance 3D Printer (Ender 5 Plus S 1).",
  };
      ...
      <div className="max-w-7xl mx-auto bg-white shadow-lg rounded-lg p-8">
        ...
        <div className="text-sm breadcrumbs text-gray-600 mb-4">
                <motion.h2
                  ...
                  transition={{ duration: 0.6 }}
                >
                  <span>Home</span> &gt; <span>Products</span> &gt; <span className="text-purple-600">3D Printer (Ender 5 Plus)</span>
                  </motion.h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          ...
          >
            <Image
              src="/images/printer4.png"
              alt="3D Printer (Creator 3)"
              width={600}
              height={600}
          ...
          >
            <h3 className="text-2xl md:text-3xl font-semibold text-gray-800">3D Printer (Ender 5 Plus S 1)</h3>
            <p className="text-gray-600 leading-relaxed">
              Bring ideas to life with the high-performance 3D Printer (Ender 5 Plus).
...
export default PrinterDetails4;
