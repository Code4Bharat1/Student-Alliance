      ...
      <div className="max-w-7xl mx-auto bg-white shadow-lg rounded-lg p-8">
        ...
        <div className="text-sm breadcrumbs text-gray-600 mb-4">
                <motion.h2
                  ...
                  transition={{ duration: 0.6 }}
                >
                  <span>Home</span> &gt; <span>Products</span> &gt; <span className="text-purple-600">98" Inch IFPD - Interactive Flat Panel Display</span>
                  </motion.h2>
                </div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          ...
          >
            <Image
              src="/images/98_inch.png" // Update this path to the actual 75 inch image if needed
              alt='98" Inch IFPD - Interactive Flat Panel Display'
              width={600}
              height={600}
          ...
          >
            <h3 className="text-2xl md:text-3xl font-semibold text-gray-800">98" Inch IFPD - Interactive Flat Panel Display</h3>
            <p className="text-gray-600 leading-relaxed">
              Our 98" Interactive Flat Panel Display is designed for powerful collaboration and immersive presentations. 
