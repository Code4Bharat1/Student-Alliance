    ...
    <div className="min-h-screen bg-gray-100 px-4 py-0">
      <div className="max-w-7xl mx-auto bg-white shadow-lg rounded-lg p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          ...
          >
            <Image
              src="/images/65_inch.png" // Update this path to the actual 75 inch image if needed
              alt='65" Inch IFPD - Interactive Flat Panel Display'
              width={600}
              height={600}
          ...
          >
            <h3 className="text-2xl md:text-3xl font-semibold text-gray-800">65" Inch IFPD - Interactive Flat Panel Display</h3>
            <p className="text-gray-600 leading-relaxed">
              Our 65" Interactive Flat Panel Display is designed for powerful collaboration and immersive presentations. 
