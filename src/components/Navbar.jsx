              ...
              <div className="relative" key={label} ref={dropdownRef}>
                <button
                  ...
                  className={`flex items-center text-black hover:text-blue-600 focus:outline-none ${
                    isProductActive ? "border-b-2 border-blue-600" : ""
                  }`}
                >
                  {label}
                  ...
                  <div className="absolute top-full left-0 bg-white shadow-lg rounded-md mt-1 z-10 w-50">
                    <Link
                      ...
                      className={`block px-4 py-2 text-sm text-black hover:bg-blue-100 ${
                        pathname === "/Prod" ? "bg-blue-100 font-medium" : ""
                      }`}
                    >
                      IFPD
                    </Link>
                    <Link
                      href="/printer"
                      className={`block px-4 py-2 text-sm text-black hover:bg-blue-100 ${
                        pathname === "/printer" ? "bg-blue-100 font-medium" : ""
                      }`}
                    >
                      3D Printers
                    </Link>
                    <Link
                      href="/kits"
                      className={`block px-4 py-2 text-sm text-black hover:bg-blue-100 ${
                        pathname === "/kits" ? "bg-blue-100 font-medium" : ""
                      }`}
                    >
                      STEM & Robotics
                    </Link>
              ...
              >
                <Link
                  ...
                  className={`relative text-black hover:text-blue-600 ${
                    pathname === href
                      ? "after:content-[''] after:absolute after:left-0 after:bottom-[-5px] after:w-full after:h-[2px] after:bg-blue-600"
                      : ""
                  }`}
                >
                  {label}
